  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        href: "/leads",
        label: "Leadlar",
        icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="5" height="18" rx="1"/><rect x="10" y="3" width="5" height="18" rx="1"/><rect x="17" y="3" width="4" height="18" rx="1"/></svg>),
      },
    ],
  },
  {
    ...
    items: [
      {
        href: "/bookings",
        label: "Bronlar",
        icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 7H4a2 2 0 0 0-2 2v6c0 1.1.9 2 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>),
      },
      {
        href: "/slots",
        label: "Vaqt slotlari",
    ...
    items: [
      {
        href: "/revenue",
        label: "Daromad",
        icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="2" y1="20" x2="22" y2="20"/></svg>),
      },
      {
        href: "/tariffs",
        label: "Tariflar",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        href: "/settings",
        label: "Sozlamalar",
        icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93A10 10 0 0 0 4.93 19.07M4.93 4.93a10 10 0 0 0 14.14 14.14"/></svg>),
      },
    ],
  },
];
      ...
      <aside id="admin-sidebar" className={`sidebar${open ? " open" : ""}`}>
        <div className="sidebar-brand">
          <div className="sidebar-brand-row">
            ...
            <div>
              <p className="sidebar-eyebrow">Advokat • Admin Panel</p>
              <p className="sidebar-title">Turdimatov M.M.</p>
            </div>
          </div>
          <p className="sidebar-subtitle">Yuridik xizmatlar boshqaruvi</p>
        </div>
          ...
          {navGroups.map(group => (
            <div key={group.label} className="sidebar-nav-section">
              ...
              {group.items.map(item => {
                ...
                const hasBadge = (item as { badge?: boolean }).badge && pendingCount > 0;
                return (
                  <Link
                    key={item.href}
                    href={item.href}
